...
<h3 className="mdx-subtitle"> Programming Boot Camps and Pandemics</h3>
...
<h3 className="mdx-subtitle">Homeschooling and Working Full-time</h3>
...
<h3 className="mdx-subtitle"> Learning Takes Various Forms</h3>
...
<h3 className="mdx-subtitle"> Saving Money and Time</h3>
...
<h3 className="mdx-subtitle"> Inspiring Work</h3>
...
<h3 className="mdx-subtitle"> A Side Note About Video games</h3>
